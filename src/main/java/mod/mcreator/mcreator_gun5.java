...
public class mcreator_gun5 {

public mcreator_gun5(){}
...
GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"012", "345", "678", Character.valueOf('0'), new ItemStack(Items.iron_ingot, 1), Character.valueOf('1'), new ItemStack(Items.flint, 1), Character.valueOf('2'), new ItemStack(Items.iron_ingot, 1), Character.valueOf('3'), new ItemStack(Items.iron_ingot, 1), Character.valueOf('4'), new ItemStack(Items.flint, 1), Character.valueOf('5'), new ItemStack(Items.iron_ingot, 1), Character.valueOf('6'), new ItemStack(Items.iron_ingot, 1), Character.valueOf('7'), new ItemStack(Items.iron_ingot, 1), Character.valueOf('8'), new ItemStack(Items.iron_ingot, 1), 
});
}
...
static{
block = (new ItemgGUN());
Item.itemRegistry.addObject(471, "gun5", block);
}
...
public int getMaxItemUseDuration(ItemStack par1ItemStack)
   ...
   public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, final EntityPlayer par3EntityPlayer){
        ...
        if (flag || par3EntityPlayer.inventory.hasItem(Items.flint))
        {
            float f = 1.0F;
            ...
            {
                par3EntityPlayer.inventory.consumeInventoryItem(Items.flint);
            }
...
if(true){
world.playSoundEffect((double)i + 0.5D, (double)j + 0.5D, (double)k + 0.5D, "random.explode1", 1.0F, 1.0F);
}
