...
public class mcreator_item{

public mcreator_item(){}
...
static{
block = (new Itemitem(490));
Item.itemRegistry.addObject(490, "Item", block);

}

static class Itemitem extends Item{

public Itemitem(int par1){
setMaxDamage(0);
maxStackSize = 64;
