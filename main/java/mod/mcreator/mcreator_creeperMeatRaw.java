...
public class mcreator_creeperMeatRaw {

public mcreator_creeperMeatRaw(){}
...
static{
block = (Item)(new BlockCustomFood(2, 0.3F, true));block = ((BlockCustomFood)block).setUnlocalizedName("CreeperMeatRaw").setTextureName("Creeper_Meat");
block.setMaxStackSize(64);
Item.itemRegistry.addObject(452, "CreeperMeatRaw", block);
