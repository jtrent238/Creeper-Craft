...
public class mcreator_jtrent238 {
	...
	public void registerRenderers(){
		RenderingRegistry.registerEntityRenderingHandler(mcreator_jtrent238.Entityjtrent238.class, new RenderBiped(new ModelBiped(), 0){protected ResourceLocation getEntityTexture(Entity par1Entity){return new ResourceLocation("jtrent2384014602983126071818.png");}
...
BossStatus.setBossStatus((Entityjtrent238)par1EntityLiving, false);
   ...
   public static class Entityjtrent238 extends EntityZombie implements IBossDisplayData
	{
		World world = null;
