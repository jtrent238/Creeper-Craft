...
public class mcreator_creeperGun {

public mcreator_creeperGun(){}
...
static{
block = (new ItemgGUN());
Item.itemRegistry.addObject(429, "creeperGun", block);
}
...
maxStackSize = 1;
setFull3D();
setUnlocalizedName("creeperGun");
setTextureName("creepergun");
...
public int getMaxItemUseDuration(ItemStack par1ItemStack)
   ...
   public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, final EntityPlayer par3EntityPlayer){
        ...
        if (flag || par3EntityPlayer.inventory.hasItem(Items.gunpowder))
        {
            float f = 1.0F;
