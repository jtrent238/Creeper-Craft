...
public class mcreator_creeperGuts {

public mcreator_creeperGuts(){}
...
static{
block = (Item)(new BlockCustomFood(1, 0.3F, true));block = ((BlockCustomFood)block).setUnlocalizedName("CreeperGuts").setTextureName("CreeperGuts");
block.setMaxStackSize(64);
Item.itemRegistry.addObject(460, "CreeperGuts", block);
