...
public class mcreator_creeperBiome {

public static BiomeGencreeperBiome biome = new BiomeGencreeperBiome();

public Object instance;

public mcreator_creeperBiome(){}

public void load(){
BiomeDictionary.registerBiomeType(biome, BiomeDictionary.Type.FOREST);
BiomeManager.addSpawnBiome(biome);
BiomeManager.warmBiomes.add(new BiomeManager.BiomeEntry(biome, 0));
}
...
static class BiomeGencreeperBiome extends BiomeGenBase
{
	@SuppressWarnings("unchecked")
    public BiomeGencreeperBiome()
    {
        super(40);
        setBiomeName("creeperBiome");
        topBlock = mcreator_creeprStone.block;
        fillerBlock = mcreator_creeprStone.block;
...
this.spawnableMonsterList.add(new SpawnListEntry(mcreator_creeperKing.EntitycreeperKing.class, 5, 1, 5));
...
class Tree extends WorldGenerator
{
                ...
                for (int var10 = par3 - var9; var10 <= par3 + var9 && var7; ++var10)
                {
                    for (var11 = par5 - var9; var11 <= par5 + var9 && var7; ++var11)
                    {
                        if (var8 >= 0 && var8 < 256)
                        {
                            ...
                            if (var12 != 0 && var12s != mcreator_creeprStone.block && var12s != Blocks.grass && var12s != Blocks.dirt && var12s != mcreator_creeprStone.block)
                            {
                                var7 = false;
                            }
                        }
            ...
            else
            {
                ...
                if ((var8s == Blocks.grass || var8s == Blocks.dirt) && par4 < 256 - var6 - 1)
                {
                    ...
                    for (var11 = par4 - var9 + var6; var11 <= par4 + var6; ++var11)
                    {
                        ...
                        for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
                        {
                            ...
                            for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16)
                            {
                                ...
                                {
                                    par1World.setBlock(var14, var11, var16, mcreator_creeprStone.block, this.metaLeaves, 2);
                                }
                            }
                        }
                    }
                    ...
                    for (var11 = 0; var11 < var6; ++var11)
                    {
                        ...
                        if (var12 == 0 || var12s == mcreator_creeprStone.block)
                        {
                            par1World.setBlock(par3, par4 + var11, par5, mcreator_creeprStone.block, this.metaWood, 2);

                            if (this.vinesGrow && var11 > 0)
                            {
                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 - 1, par4 + var11, par5))
                                {
                                    par1World.setBlock(par3 - 1, par4 + var11, par5, mcreator_creeprStone.block, 8, 2);
                                }

                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 1, par4 + var11, par5))
                                {
                                    par1World.setBlock(par3 + 1, par4 + var11, par5, mcreator_creeprStone.block, 2, 2);
                                }

                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + var11, par5 - 1))
                                {
                                    par1World.setBlock(par3, par4 + var11, par5 - 1, mcreator_creeprStone.block, 1, 2);
                                }

                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + var11, par5 + 1))
                                {
                                    par1World.setBlock(par3, par4 + var11, par5 + 1, mcreator_creeprStone.block, 4, 2);
                                }
                            }
                        }
                    }
                    ...
                    if (this.vinesGrow)
                    {
                        for (var11 = par4 - 3 + var6; var11 <= par4 + var6; ++var11)
                        {
                            ...
                            for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
                            {
                                ...
                                {
                                    if (par1World.getBlock(var14, var11, var15) == mcreator_creeprStone.block)
                                    {
                            ...
                            for (var11 = 0; var11 < 2; ++var11)
                            {
                                for (var12 = 0; var12 < 4; ++var12)
                                {
                                    if (par2Random.nextInt(4 - var11) == 0)
                                    {
                                        ...
                                        par1World.setBlock(par3 + Direction.offsetX[Direction.rotateOpposite[var12]], par4 + var6 - 5 + var11, par5 + Direction.offsetZ[Direction.rotateOpposite[var12]], mcreator_creeprStone.block, var13 << 2 | var12, 2);
                                    }
                                }
                            }
                        }
    ...
    private void growVines(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        while (true)
        {
            ...
            par1World.setBlock(par2, par3, par4, mcreator_creeprStone.block, par5, 2);
            --var6;
        }
    }
}
...
//0 - visina
//false - true/false za vin
//mcreator_creeprStone.block - block za vine
//mcreator_creeprStone.block - block za cez les
//mcreator_creeprStone.block - block za listje
//mcreator_creeprStone.block - block za coce

    @SideOnly(Side.CLIENT)
public int getBiomeGrassColor(){return 0xffffff;}
@SideOnly(Side.CLIENT)
public int getBiomeFoliageColor(){return 0xffffff;}
@SideOnly(Side.CLIENT)
public int getSkyColorByTemp(float par1){return 0x006600;}
