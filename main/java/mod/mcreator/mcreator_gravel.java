...
public class mcreator_gravel {

public static BiomeGengravel biome = new BiomeGengravel();

public Object instance;

public mcreator_gravel(){}
...
static class BiomeGengravel extends BiomeGenBase
{
	@SuppressWarnings("unchecked")
    public BiomeGengravel()
    {
        super(42);
        setBiomeName("gravel");
